    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                ...
                {{-- <img src={{ asset('/storage/' . 'apiProduct/3K3WskGp1azAWIjZ52I8haIBp9X1sb2GwxwFLmTi.png') }} /> --}}
                <img class="card-img-top"
                    src="{{ asset('storage/apiProduct/95cwmnYX835XOo8girxyVWsPvEhFnvheJ336Srei.png') }}"
                    alt="Card image cap" style="width:9vw; height:12vw; border-radius:20px;">
            </div>
        </div>
    </div>
</body>
